...
@dataclass
class LatentNerfDataManagerConfig(VanillaDataManagerConfig):
    """Configuration for the LatentNerfDataManager."""

    _target: Type = field(default_factory=lambda: LatentNerfDataManager)

class LatentNerfDataManager(VanillaDataManager):
    """Data manager for LatentNerf."""

    config: LatentNerfDataManagerConfig
